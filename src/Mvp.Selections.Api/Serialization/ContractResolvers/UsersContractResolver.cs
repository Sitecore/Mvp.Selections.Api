...
public class UsersContractResolver : CamelCasePropertyNamesContractResolver
{
    ...
    private readonly string[] _userExcludedMembers = [nameof(User.Consents), nameof(User.Applications), nameof(User.Mentors), nameof(User.Reviews), nameof(User.IsMentor), nameof(User.IsOpenToNewMentees), nameof(User.MentorDescription)];
