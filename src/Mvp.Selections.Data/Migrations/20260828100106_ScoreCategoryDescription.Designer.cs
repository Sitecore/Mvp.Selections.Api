...
namespace Mvp.Selections.Data.Migrations
{
    ...
    [Migration("20260828100106_ScoreCategoryDescription")]
    partial class ScoreCategoryDescription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mvp.Selections.Domain.User", b =>
                {
                    ...
                    b.Property<bool>("IsOpenToNewMentees")
                        .HasColumnType("bit");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImageType = 0,
                            IsMentor = false,
                            IsOpenToNewMentees = false,
                            Name = "Ivan Lieckens"
                        });
                });

            modelBuilder.Entity("MvpTypeSelection", b =>
                {
                    b.Property<short>("MvpTypesId")
                        .HasColumnType("smallint");

                    b.Property<Guid>("SelectionsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("MvpTypesId", "SelectionsId");
            ...
            modelBuilder.Entity("MvpTypeSelection", b =>
                {
                    b.HasOne("Mvp.Selections.Domain.MvpType", null)
                        .WithMany()
                        .HasForeignKey("MvpTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mvp.Selections.Domain.Selection", null)
                        .WithMany()
